                    ...
                    <a class="nav-link px-3 sidebar-link" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                      ...
                      <div class="collapse" id="collapseExample">
                        ...
                        <ul class="navbar-nav ps-5">
                            <li>
                                <a href="../staff/ceate.php" class="nav-link">
                                    <span class="me-2">
                ...
                <li>
                    <a class="nav-link px-3 sidebar-link" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                      ...
                      <div class="collapse" id="collapseExample">
                        ...
                        <ul class="navbar-nav ps-5">
                            <li>
                                <a href="../pass/create.php" class="nav-link">
                                    <span class="me-2">
                            ...
                            <li>
                                <a href="../pass/details.php" class="nav-link">
                                    <span class="me-2">
                ...
                <li>
                    <a class="nav-link px-3 sidebar-link" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                      ...
                      <div class="collapse" id="collapseExample">
                        ...
                        <ul class="navbar-nav ps-5">
                            <li>
                                <a href="../report/BWdates.php" class="nav-link">
                                    <span class="me-2">
                            ...
                            <li>
                                <a href="../report/passcount.php" class="nav-link">
                                    <span class="me-2">
                            ...
                            <li>
                                <a href="../report/passsales.php" class="nav-link">
                                    <span class="me-2">
