          ...
          <div class="col-lg-7 offset-md-2">
              ...
              <div class="card card-outline-secondary text-right ml-5">
                  <div class="card-header">
                      <h3 class="mb-0">Information update</h3>
                  </div>
                  ...
                  <div class="card-body">
                      ...
                      <div class="col-lg-9">
                          ...
                          <div class="form-check">
                                ...
                                <input class="form-check-input col-lg-9" type="checkbox" name='admin' id="flexCheckDefault">
                                    Admin 
                                </label>
                            </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-lg-9">
                                  ...
                                  <input type="submit" name='change-user' class="btn btn-primary" value="Save Changes">
                              </div>
                          </div>
